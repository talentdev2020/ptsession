...
import { updateProfile, updateAvatar } from '../../redux/actions';
...
class EditProfileForm extends Component {
  ...
  handleSubmit = (values, { setSubmitting }) => {
    ...
    this.props.updateAvatar({ avatar: data.avatar });
  };
                ...
                >
                  {({
                    ...
                    <Form className='av-tooltip tooltip-label-bottom'>
                      ...
                      <Row>
                        <FormGroup className='col form-group has-float-label'>
                          <Label className='ml-3'>About Me</Label>
                          <textarea
...
export default connect(mapStateToProps, { updateProfile, updateAvatar })(
  EditProfileForm
);
